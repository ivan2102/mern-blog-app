...
const {loading, appError, serverError, user} = authStore
...
const formik = useFormik({
  ...
  return (
    <section className="relative py-20 2xl:py-40 bg-gray-700 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-wrap items-center -mx-4">
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="px-6 lg:px-20 py-12 lg:py-24 bg-indigo-400 rounded-lg">
                <form onSubmit={formik.handleSubmit}>
                  {/* error message */}
                  {appError || serverError ? <h2 className="text-red-500">{serverError} {appError}</h2> : null}
