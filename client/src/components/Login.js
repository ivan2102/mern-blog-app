...
const Login = () => {
  ...
  const { appError, serverError, user} = loginStore
  ...
  return (
    <>
      <section className="min-h-screen relative py-20 2xl:py-40 bg-gray-700 overflow-hidden">
              ...
              <div className="w-full lg:w-2/5 px-4">
                <div className="px-6 lg:px-12 py-12 lg:py-24 bg-white shadow-lg rounded-lg">
                  ...
                  <form onSubmit={formik.handleSubmit}>
                    {/* error message */}
                    {serverError || appError ? <h2 className="text-red-500">{serverError} - {appError}</h2> : null }
