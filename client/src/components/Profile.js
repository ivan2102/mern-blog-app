...
import { userProfile, followUser, unfollowUser } from "../slices/authSlices";
...
export default function Profile() {
  ...
  const { user, loading, follow, unfollow, userAppError, userServerError } =
    userState;
                          ...
                          <div className="mt-6 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                            <div className=" flex flex-col 2xl:block mt-10 min-w-0 flex-1">
                              ...
                              <div className="flex items-center  mb-2">
                                ...
                                <div className="pl-2">
                                  ...
                                  <span className="text-indigo-400 cursor-pointer">
                                    Users viewed your profile {user?.viewedBy?.length}
                                  </span>
                                </div>
                              </div>
                              ...
                              <Link
                                ...
                                className="inline-flex justify-center w-48 px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-gray-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                              >
                                <UploadIcon
                            ...
                            <div className="mt-6 flex flex-col justify-stretch space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4">
                              ...
                              <>
                                <Link
                                  ...
                                  className="inline-flex justify-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-gray-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                                >
                                  <UserIcon
                                    className="-ml-1 mr-2 h-5 w-5 text-gray-400"
                                    aria-hidden="true"
                    ...
                    <div className="flex justify-center place-items-start flex-wrap  md:mb-0">
                      <div className="w-full md:w-1/3 px-4 mb-4 md:mb-0">
                        <h1 className="text-center text-xl border-gray-500 mb-2 border-b-2">
                          Who viewed my profile : {user?.viewedBy?.length}
                        </h1>

                        {/* Who view my post */}
                        <ul className="">
                        {user?.viewedBy?.length <= 0 ? <h1>No one viewed your profile yet</h1> : 
                        user?.viewedBy?.map(user => (
