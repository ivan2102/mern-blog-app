...
import { blockUser, unBlockUser } from "../../slices/authSlices";
...
const dispatch = useDispatch()
  ...
  return (
    <>
      <div className="p-8 mb-4 bg-gray-300 shadow rounded">
        <div className="flex flex-wrap items-center -mx-4">
          ...
          <div className="w-full flex lg:w-4/12 px-4  mb-6 lg:mb-0">
            <p className="inline-block py-1 px-2 mr-2 mb-1 lg:mb-0 text-xs border-2 rounded">
              <span className="text-base mr-2  boder-2 text-bold text-blue-700">
            ...
            <button
              ...
              className="inline-flex  justify-center bg-blue-400 px-2   border border-blue-800 shadow-sm text-sm font-medium rounded-md text-blue-700  hover:bg-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
            >
              <MailIcon
